    ...
    .cta-button:hover {
      ...
      <div className="p-5 md:pl-10 md:pr-10 pt-5 ">
        <div id="introduction" className=" md:pl-10 md:pr-10">
          ...
          <div className="webinar-details bg-[#024978] grid justify-center text-center items-center mt-8 pt-10 pb-10  md:px-4 poppins-medium gap-8 md:flex md:gap-10 md:justify-around ">
